...
|---------|-----|--------|-------|
| Loyala Web (Vercel) | `https://loyala-ai-web.vercel.app/api/health` | ✅ 200 | `checks.supabase = ok`, version `a057d46` |
...
| `GET /api/health` (Vercel loyala web) | 200 | `status: ok`, `checks.supabase = ok` | ✅ |
